...
export default function WhatsAppButton() {
  ...
  const whatsappLink = `https://wa.me/5492254587288?text=${mensaje}`;

  return (
    <Link
      href={whatsappLink}
      target="_blank"
      className="fixed bottom-6 right-6 z-50 w-16 h-16 md:w-20 md:h-20 rounded-full shadow-lg bg-green-500 hover:bg-green-400 flex items-center justify-center transition"
    >
      <svg
